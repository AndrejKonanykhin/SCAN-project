      ...
      <div className={classes["user-panel"]}>
        {userInfo.isLoading ? (
          ...
          <div className={classes["user-info"]}>
            <span className={classes["user-info-used-text"]}>
              Использовано компаний
            </span>
            <span className={classes["user-info-used-count"]}>
              {userInfo.usedCompanyCount}
            </span>

            <span className={classes["user-info-limit-text"]}>
              Лимит по компаниям
            </span>
            <span className={classes["user-info-limit-count"]}>
